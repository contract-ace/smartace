...
// RUN: make icmodel
// RUN: echo 1 0 0 100 1 1 0 0 0 2 1 2 0 0 0 3 1 3 0 0 0 4 1 1 0 0 1 2 1 2 0 0 1 3 1 3 0 0 1 4 1 4 0 0 0 10 1 4 0 0 1 10 5 | ./icmodel --return-0 --count-transactions 2>&1 | OutputCheck %s --comment=//
// CHECK: assert
