...
// RUN: make icmodel
// RUN: echo 1 2 3 100 1 0 1 1 0 0 2 3 10 1 1 0 1 2 3 10 1 2 0 0 2 3 10 1 2 0 1 2 3 10 1 5 0 1 2 3 10 5 | ./icmodel --return-0 --count-transactions 2>&1 | OutputCheck %s --comment=//
// CHECK: assert
