...
// RUN: make icmodel
// RUN: echo 0 0 0 1 0 0 0 0 1 2 10 1 0 0 0 1 1 2 10 1 1 0 0 0 1 2 10 1 1 0 0 1 1 2 10 1 4 0 0 1 1 2 10 | ./icmodel --return-0 --count-transactions 2>&1 | OutputCheck %s --comment=//
// CHECK: assert
