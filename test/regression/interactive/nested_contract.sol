...
// RUN: make icmodel
// RUN: echo 1 10 20 1 0 1 1 0 0 | ./icmodel --return-0 --count-transactions 2>&1 | OutputCheck %s --comment=//
// RUN: echo 1 10 20 1 0 1 1 0 1 | ./icmodel --return-0 --count-transactions 2>&1 | OutputCheck %s --comment=//
// RUN: echo 1 10 20 1 0 1 1 0 2 4 | ./icmodel --return-0 --count-transactions 2>&1 | OutputCheck %s --comment=//
// CHECK: assert
