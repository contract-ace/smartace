...
BOOST_AUTO_TEST_CASE(add_to_primitives)
{
    ...
    CallGraph call_graph(alloc_graph, flat_model);
...
BOOST_AUTO_TEST_CASE(detects_payments)
{
    ...
    CallGraph call_graph_a(alloc_graph_a, flat_model_a);
    ...
    CallGraph call_graph_b(alloc_graph_b, flat_model_b);
    ...
    CallGraph call_graph_c(alloc_graph_c, flat_model_c);
