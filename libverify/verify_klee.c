...
uint8_t nd_byte(uint8_t tmp, const char* _msg)
{
	(void) tmp;
    uint8_t res;
...
uint8_t nd_range(uint8_t tmp, uint8_t l, uint8_t u, const char* _msg)
{
	(void) tmp;
    uint8_t res;
    klee_make_symbolic(&res, sizeof(res), _msg);
...
sol_raw_uint8_t nd_uint8_t(sol_raw_uint8_t tmp, const char* _msg)
{
	(void) tmp;
	sol_raw_uint8_t res;
	klee_make_symbolic(&res, sizeof(res), _msg);
...
sol_raw_uint16_t nd_uint16_t(sol_raw_uint16_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint24_t nd_uint24_t(sol_raw_uint24_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint32_t nd_uint32_t(sol_raw_uint32_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint40_t nd_uint40_t(sol_raw_uint40_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint48_t nd_uint48_t(sol_raw_uint48_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint56_t nd_uint56_t(sol_raw_uint56_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint64_t nd_uint64_t(sol_raw_uint64_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint72_t nd_uint72_t(sol_raw_uint72_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint80_t nd_uint80_t(sol_raw_uint80_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint88_t nd_uint88_t(sol_raw_uint88_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint96_t nd_uint96_t(sol_raw_uint96_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint104_t nd_uint104_t(sol_raw_uint104_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint112_t nd_uint112_t(sol_raw_uint112_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint120_t nd_uint120_t(sol_raw_uint120_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint128_t nd_uint128_t(sol_raw_uint128_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint136_t nd_uint136_t(sol_raw_uint136_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint144_t nd_uint144_t(sol_raw_uint144_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint152_t nd_uint152_t(sol_raw_uint152_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint160_t nd_uint160_t(sol_raw_uint160_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint168_t nd_uint168_t(sol_raw_uint168_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint176_t nd_uint176_t(sol_raw_uint176_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint184_t nd_uint184_t(sol_raw_uint184_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint192_t nd_uint192_t(sol_raw_uint192_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint200_t nd_uint200_t(sol_raw_uint200_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint208_t nd_uint208_t(sol_raw_uint208_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint216_t nd_uint216_t(sol_raw_uint216_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint224_t nd_uint224_t(sol_raw_uint224_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint232_t nd_uint232_t(sol_raw_uint232_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint240_t nd_uint240_t(sol_raw_uint240_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint248_t nd_uint248_t(sol_raw_uint248_t tmp, const char* _msg)
{
	(void) tmp;
...
sol_raw_uint256_t nd_uint256_t(sol_raw_uint256_t tmp, const char* _msg)
{
	(void) tmp;
